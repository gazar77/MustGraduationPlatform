...
public class SiteSettingsService : ISiteSettingsService
{
    ...
    private static void ValidateAllowedHeroImagePath(string path)
    {
        ...
        if (!lower.StartsWith("/assets/", StringComparison.Ordinal) && !lower.StartsWith("/uploads/", StringComparison.Ordinal))
            throw new AppException("VALIDATION_HERO_SLIDER", "مسار الصورة يجب أن يبدأ بـ /assets/ أو /uploads/");
    }
}
